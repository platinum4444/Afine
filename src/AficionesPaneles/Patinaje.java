...
public class Patinaje extends JPanel {
	File fl = new File(getClass().getResource("/resources/roller-skating.png").getFile());
	BufferedImage animalImagen = new BufferedImage(100,100, BufferedImage.TYPE_INT_RGB);
	JLabel actividadLabel = new JLabel("Patinaje");
	...
	public Patinaje() {
		 ...
		 gustaButton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Usuario.aficiones[Usuario.aficionesRellenadasIndice] = "patinaje";
				Usuario.aficionesRellenadasIndice++;
				ManejarPaginas.cambiarPanel(8);
				setVisible(false);
			}
