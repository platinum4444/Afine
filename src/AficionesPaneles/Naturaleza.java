...
public class Naturaleza extends JPanel {
	File fl = new File(getClass().getResource("/resources/plant.png").getFile());
	BufferedImage animalImagen = new BufferedImage(100,100, BufferedImage.TYPE_INT_RGB);
	JLabel actividadLabel = new JLabel("Naturaleza");
	...
	public Naturaleza() {
		 ...
		 gustaButton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Usuario.aficiones[Usuario.aficionesRellenadasIndice] = "naturaleza";
				Usuario.aficionesRellenadasIndice++;
				ManejarPaginas.cambiarPanel(7);
				setVisible(false);
			}
