...
public class Lectura extends JPanel {
	File fl = new File(getClass().getResource("/resources/sitting-reading.png").getFile());
	BufferedImage animalImagen = new BufferedImage(100,100, BufferedImage.TYPE_INT_RGB);
	JLabel actividadLabel = new JLabel("Lectura");
	...
	public Lectura() {
		 ...
		 gustaButton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Usuario.aficiones[Usuario.aficionesRellenadasIndice] = "lectura";
				Usuario.aficionesRellenadasIndice++;
				ManejarPaginas.cambiarPanel(6);
				setVisible(false);
			}
