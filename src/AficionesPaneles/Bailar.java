...
public class Bailar extends JPanel {
	File fl = new File(getClass().getResource("/resources/dancing.png").getFile());
	BufferedImage animalImagen = new BufferedImage(100,100, BufferedImage.TYPE_INT_RGB);
	JLabel actividadLabel = new JLabel("Bailar");
	...
	public Bailar() {
		 ...
		 gustaButton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Usuario.aficiones[Usuario.aficionesRellenadasIndice] = "bailar";
				Usuario.aficionesRellenadasIndice++;
				ManejarPaginas.cambiarPanel(9);
				setVisible(false);
			}
