...
public class Comer extends JPanel {
	File fl = new File(getClass().getResource("/resources/ice-cream.png").getFile());
	BufferedImage animalImagen = new BufferedImage(100,100, BufferedImage.TYPE_INT_RGB);
	JLabel actividadLabel = new JLabel("Comer");
	...
	public Comer() {
		 ...
		 gustaButton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Usuario.aficiones[Usuario.aficionesRellenadasIndice] = "comer";
				Usuario.aficionesRellenadasIndice++;
				ManejarPaginas.cambiarPanel(4);
				setVisible(false);
			}
