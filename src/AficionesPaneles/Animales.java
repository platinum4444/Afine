...
public class Animales extends JPanel{
	File fl = new File(getClass().getResource("/resources/Doggie.png").getFile());
	BufferedImage animalImagen = new BufferedImage(100,100, BufferedImage.TYPE_INT_RGB);
	JLabel actividadLabel = new JLabel("Animales");
	...
	public Animales() {
		 ...
		 gustaButton.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Usuario.aficiones[Usuario.aficionesRellenadasIndice] = "animales";
				Usuario.aficionesRellenadasIndice++;
				ManejarPaginas.cambiarPanel(3);
				setVisible(false);
			}
